...
var fs = require("fs");
var MyLambdaFunction = require('../index.js'); // Your Lambda source with exports.handler

var MyDialog = './staterequest.txt';
...
fs.readFile(MyDialog, function(err, data) { // open dialog sequence file and read Intents
  ...
  for (let i = 0; i < lineArray.length; i++) {
    runSingleTest(lineArray, i, {});
    // console.log('----returned from runSingleTest2');
  }
});
